    ...
    <>
      <section className="Home h-screen flex flex-col xl:flex-row xl:justify-between  text-center">
        <div className="flex-grow">
          ...
          <div
            id="home-main"
            className="py-10 md:py-20 lg:py-26 flex flex-grow flex-col items-center gap-4 md:gap-6 xl:gap-10 px-3"
          >
        ...
        <div id="home-img" className="flex-grow text-left xl:w-2/12">
          <span className="flex gap-1 items-center xl:absolute xl:right-10 xl:top-6 xl:text-[#F3EFEA]">
