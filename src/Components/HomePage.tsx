...
export default function HomePage() {
  const hover = "hover:tracking-wider duration-300";
  return (
    <>
      <Header />
      <section className="Home h-screen flex flex-col px-2 text-center">
        <div id="home-main" className="py-10 md:py-32 flex flex-col items-center gap-4">
          ...
          <p className="font-light max-w-lg">
            ...
            portraits. Each piece is a reflection of my passion, creativity, and
          ...
          <span className="flex items-center gap-1 w-full justify-center pt-2">
            Follow on Instagram <i className="fa-solid fa-arrow-right"></i>
          </span>
        </div>

        <div id="home-img" className="flex-grow text-left">
          <span className="flex gap-1 items-center">
            <h2 className={hover}>Latest Collection</h2>
            <i className="fa-solid fa-arrow-right"></i>
          </span>
          <img
            src="https://images.pexels.com/photos/1981468/pexels-photo-1981468.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"
            alt="Your Image"
